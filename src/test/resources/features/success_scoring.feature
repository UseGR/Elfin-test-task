...
Функционал: Скоринг-оценка компании. Успешный результат

  Предыстория:
    Дано все файлы этого сценария расположены в директории 'scenario/success/'
  ...
  Сценарий: Успешный результат скоринг-оценки компании
    ...
    И переменная 'is_scoring_failed' должна быть равна 'false'
